...
def main():	
	...
	train_french, train_english, french_vocab, english_vocab = get_part2_data('/content/gdrive/My Drive/Colab Notebooks/Deep Learning/Assignment 4/data/fls.txt','/content/gdrive/My Drive/Colab Notebooks/Deep Learning/Assignment 4/data/els.txt')
	train_short_french, train_short_english, _, _ = get_part2_data('/content/gdrive/My Drive/Colab Notebooks/Deep Learning/Assignment 4/data/fls_short.txt','/content/gdrive/My Drive/Colab Notebooks/Deep Learning/Assignment 4/data/els_short.txt', french_vocab, english_vocab)
	test_french, test_english, _, _ = get_part2_data('/content/gdrive/My Drive/Colab Notebooks/Deep Learning/Assignment 4/data/flt.txt','/content/gdrive/My Drive/Colab Notebooks/Deep Learning/Assignment 4/data/elt.txt', french_vocab, english_vocab)
	...
	#	  input_vocab=french_reverse_vocab, output_vocab=english_reverse_vocab, debug=True, test=test_while_training)
